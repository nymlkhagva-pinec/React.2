    ...
    <div>
      <div className="w-xs  flex flex-col items-center rounded-2xl shadow-2xl relative">
        ...
        <img
          ...
          className="rounded-full absolute top-16 border-white border-8"
        />
        ...
        <div className="flex flex-col items-center pt-15">
          ...
          <button
            onClick={handleSave}
            className={`m-2 p-2 rounded-xl transition-all ease-in-out duration-300 w-50 ${user.isSave ? "bg-gray-200" : "bg-black text-white"}`}
          >
